...
export default class FuturePathway {
  constructor(pathwayID = "", careerGoals = [], generatedDate = null) {
    this.pathwayID = pathwayID;             // String
    this.careerGoals = careerGoals;         // List
    this.generatedDate = generatedDate;     // DateTime
  }
